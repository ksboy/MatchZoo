...
print('data loading ...')
train_pack_raw = mz.datasets.cb.load_data('train', task='classification')
dev_pack_raw = mz.datasets.cb.load_data('dev', task='classification')
...
history = model.fit(x, y, epochs=100, callbacks=[evaluate])
